...
export const ROUTES: Routes = [
	...
	{ path: '', children: [
		// { path: '', component: TokenComponent, canActivate: [AuthGuard], outlet: 'token'},
		{ path: '', component: HeaderComponent, canActivate: [AuthGuard], outlet: 'header' },
		{ path: '', component: NavbarComponent, canActivate: [AuthGuard], outlet: 'navbar' },
		{ path: '', component: FooterComponent, canActivate: [AuthGuard], outlet: 'footer' },
