...
var PublishAnnouncementModalData = (function (_super) {
    __extends(PublishAnnouncementModalData, _super);
    function PublishAnnouncementModalData(announcement) {
        var _this = _super.call(this) || this;
        _this.announcement = announcement;
        return _this;
    }
    return PublishAnnouncementModalData;
}(bootstrap_1.BSModalContext));
exports.PublishAnnouncementModalData = PublishAnnouncementModalData;
/**
 * A Sample of how simple it is to create a new window, with its own injects.
 */
var PublishAnnouncementModalComponent = (function () {
    function PublishAnnouncementModalComponent(dialog, anouncementService) {
        this.dialog = dialog;
        this.anouncementService = anouncementService;
        this.context = dialog.context;
        this.wrongAnswer = true;
    }
    PublishAnnouncementModalComponent.prototype.onKeyUp = function (value) {
        this.wrongAnswer = value != 5;
        this.dialog.close();
    };
    PublishAnnouncementModalComponent.prototype.beforeDismiss = function () {
        return true;
    };
    PublishAnnouncementModalComponent.prototype.beforeClose = function () {
        return this.wrongAnswer;
    };
    return PublishAnnouncementModalComponent;
}());
PublishAnnouncementModalComponent = __decorate([
    core_1.Component({
