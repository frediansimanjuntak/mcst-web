...
var EditAnnouncementComponent = (function () {
    function EditAnnouncementComponent(router, newsletterService, alertService, formbuilder) {
        this.router = router;
    ...
    EditAnnouncementComponent.prototype.createNewsletter = function (event) {
        var _this = this;
    ...
    EditAnnouncementComponent.prototype.updateNewsletter = function () {
        var _this = this;
    ...
    EditAnnouncementComponent.prototype.onChange = function (event) {
        var files = [].slice.call(event.target.files);
        this.model.attachment = files;
    };
    EditAnnouncementComponent.prototype.remove = function (i) {
