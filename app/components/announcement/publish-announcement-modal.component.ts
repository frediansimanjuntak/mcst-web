...
export class PublishAnnouncementModalData extends BSModalContext {
...
export class PublishAnnouncementModalComponent implements ModalComponent<PublishAnnouncementModalData> {
  context: PublishAnnouncementModalData;

  public wrongAnswer: boolean;

  constructor(public dialog: DialogRef<PublishAnnouncementModalData>,
