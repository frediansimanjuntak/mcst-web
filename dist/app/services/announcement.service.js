...
var AnnouncementService = (function () {
    ...
    AnnouncementService.prototype.getAnnouncements = function () {
        return Promise.resolve(index_1.Announcements);
    };
    AnnouncementService.prototype.getAnnouncement = function (id) {
        return this.getAnnouncements()
            .then(function (announcement) { return announcement.find(function (announcement) { return announcement._id === id; }); });
    };
    ...
    AnnouncementService.prototype.create = function (body) {
    ...
    AnnouncementService.prototype.update = function (body) {
        var options = new http_1.RequestOptions({
            headers: new http_1.Headers({ 'Content-Type': 'application/json;charset=UTF-8' })
        });
    ...
    AnnouncementService.prototype.delete = function (id) {
        return this.http.delete(global_1.url + 'api/announcement/' + id, { headers: this.headers })
            .toPromise()
